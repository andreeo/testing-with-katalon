...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment_comment'), 'Seoul Cura')
...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment_comment'), 'Hongking CURA')
...
WebUI.verifyElementText(findTestObject('Page_CURA Healthcare Service/h2_History'), 'History')

WebUI.verifyElementText(findTestObject('Page_CURA Healthcare Service/p_Hongkong CURA Healthcare Center'), 'Hongkong CURA Healthcare Center')

WebUI.verifyElementText(findTestObject('Page_CURA Healthcare Service/p_Seoul CURA Healthcare Center'), 'Seoul CURA Healthcare Center')
